# -*- coding: utf-8 -*-
"""
Created on Wed Aug 19 15:14:41 2015
...
class Requestor:    
    ...
    def start_job(self, workers):
        ...
        worker_list = [worker for pref,reput,worker_ in priority_list if worker_.get_ability() >= self.job.get_skill() and worker_.get_reputation() >= self.job.get_reputation()]
